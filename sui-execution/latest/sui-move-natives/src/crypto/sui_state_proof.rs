...
/// Base cost for invoking SuiStateProof Functions
#[derive(Clone)]
 ...
 **************************************************************************************************/
/// Verifies the current committee against the current checkpoint, and generates the next committee for the next epoch.
